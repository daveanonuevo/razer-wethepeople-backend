...
/**
 *
 * @class foreign_exchange_rates_api
 * @param {(string|object)} [domainOrOptions] - The project domain or options object. If object, see the object's optional properties.
 * @param {string} [domainOrOptions.domain] - The project domain
 * @param {object} [domainOrOptions.token] - auth token - object with value property and optional headerOrQueryName and isQuery properties
 */
var foreign_exchange_rates_api = (function () {
    console.log('running');
    ...
    function foreign_exchange_rates_api(options) {
    ...
    /**
     * Provide Visa daily currency conversion rate for a given currency pair based on amount
     * @method
     * @name foreign_exchange_rates_api#foreignexchangelookup
     * @param {string} xClientTransactionId -
     * @param {} foreignexchangelookupPOSTPayload - Resource body for Foreign Exchange Rates
     *
     */
    foreign_exchange_rates_api.prototype.foreignexchangelookup = function (parameters) {
        ...
        var path = '/forexrates/v1/foreignexchangerates';
    ...
    return foreign_exchange_rates_api;
})();

exports.foreign_exchange_rates_api = foreign_exchange_rates_api;